...
$query = "SELECT id, name, price, image_url FROM products WHERE product_type = 'music'";
    ...
    <div class="container">
        ...
        <section>
            ...
            <div class="responsive-iframe-container">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/D8iTxZEg7ro?si=yP9D9CjIcS-ozb-O" start=1 ; allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div>
        </section>
